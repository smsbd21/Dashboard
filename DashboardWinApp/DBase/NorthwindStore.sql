...
create table Product (
   ...
   Stock int not null,
   IsDiscontinued bit not null constraint DF_Product_IsDisco default 0,
...
create table "Order" (
   ...
   TotalAmount decimal(12,2) null constraint DF_Order_TotalAmt default 0,
...
create table OrderItem (
   ...
   UnitPrice decimal(12,2) not null constraint DF_OrderItem_UnitPrice default 0,
   Quantity int not null constraint DF_OrderItem_Qty default 1,
